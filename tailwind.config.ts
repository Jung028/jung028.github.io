  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "window-open": { from: { opacity: "0", transform: "scale(0.88)" }, to: { opacity: "1", transform: "scale(1)" } },
        "dock-bounce": { "0%, 100%": { transform: "translateY(0)" }, "40%": { transform: "translateY(-16px)" }, "60%": { transform: "translateY(-6px)" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
        "window-open": "window-open 0.3s cubic-bezier(0.16, 1, 0.3, 1)",
